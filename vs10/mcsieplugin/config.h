...
#define DLVHEX_ABI_VERSION 7.1.0
...
#define PACKAGE_TARNAME "MCSIE-Plugin"
#define MCSIEPLUGIN_VERSION_MAJOR 2
#define MCSIEPLUGIN_VERSION_MINOR 0
#define MCSIEPLUGIN_VERSION_MICRO 0
