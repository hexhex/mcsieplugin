...
namespace dlvhex {
  namespace mcsdiagexpl {
   ...
   void
   QiConverter::convertContext(node_t& at, ParseContext& context) {
     int id;
     std::string extatom;
     std::string param;
   ...
   void
   QiConverter::convertParseTreeToDLVProgram(node_t& node, std::ostream& o) {
   ...
   void
   QiConverter::convert(std::istream& i, std::ostream& o) {
